...
public class Balance {
    ...
    /*
    note that this program is set up to only maximize over the caiross crafts.

    maximizing over additional crafts (raids, ancients) requires their cost vectors to be included. If anyof the craft
    ...
    any of the materials for that given location. (i.e. for caiross crafts you not only need to include information regarding
    the green/red/purple material for caiross crafts, but also a series of indices filled with zeros in the locations
    ...
    public static void balance(int exclusion) {
        ...
        */
        ...
        //System.out.println("Giants: " + String.valueOf(x));
        //System.out.println("Dragons: " + String.valueOf(y));
        //System.out.println("Necropolis: " + String.valueOf(z));
